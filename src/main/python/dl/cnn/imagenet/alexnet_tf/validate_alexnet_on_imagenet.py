...
version :
refer :
https://github.com/kratzert/finetune_alexnet_with_tensorflow/blob/5d751d62eb4d7149f4e3fd465febf8f07d4cea9d/validate_alexnet_on_imagenet.ipynb
"""
import os
import sys
...
from dl.cnn.imagenet.alexnet_tf.caffe_classes import class_names
...
if __name__ == '__main__':
    ...
    image_dir = os.path.join(current_dir, 'images/alexnet/')
